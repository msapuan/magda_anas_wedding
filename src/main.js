...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const description = `Undangan Pernikahan Magda & Anas - ${weddingDate}. Mengharap kehadiran Anda untuk berbagi kebahagiaan di hari istimewa kami.`;

    document.title = `Magda & Anas - ${weddingDate}`;
